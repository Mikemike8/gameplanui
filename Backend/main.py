...
DEFAULT_SQLITE_URL = f"sqlite:///{BASE_DIR / 'gameplan.db'}"
...
if not DATABASE_URL:
    if all([DB_USER, DB_PASSWORD, DB_HOST, DB_PORT, DB_NAME]):
        ...
        print(
            "⚠️  DB_* environment variables missing. Falling back to local SQLite database "
            f"at {DATABASE_URL}. Set DB_HOST/DB_PORT/DB_NAME/DB_USER/DB_PASSWORD or DATABASE_URL "
            "to use Postgres (Render / shared environments)."
        )
